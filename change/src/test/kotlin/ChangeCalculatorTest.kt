...
class ChangeCalculatorTest {
    ...
    @Test
    fun errorIfNoCombinationCanAddUpToTarget2() {
        val changeCalculator = ChangeCalculator(listOf(5, 10))

        expectedException.expect(IllegalArgumentException::class.java)
        expectedException.expectMessage("The total 4 cannot be represented in the given currency.")

        changeCalculator.computeMostEfficientChange(4)
    }
